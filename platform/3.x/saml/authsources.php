...
$config = array(
    ...
    'example-userpass' => array(
        ...
        'alice:password' => array_merge($test_user_base, array(
            'http://schemas.microsoft.com/identity/claims/objectidentifier' => 'f2d75402-e1ae-40fe-8cc9-98ca1ab9cd5e',
            'http://schemas.microsoft.com/identity/claims/displayname' => 'Alice Wonder',
            'http://schemas.xmlsoap.org/ws/2005/05/identity/claims/emailaddress' => 'alice@acme.fr',
            'http://schemas.xmlsoap.org/ws/2005/05/identity/claims/givenname' => 'Alice',
            'http://schemas.xmlsoap.org/ws/2005/05/identity/claims/surname' => 'Wonder',
            'http://schemas.xmlsoap.org/ws/2005/05/identity/claims/name' => 'alice@acme.fr'
        )),
        'bob:password' => array_merge($test_user_base, array(
            'http://schemas.microsoft.com/identity/claims/objectidentifier' => 'f2a94916-2fcb-4b68-9eb1-5436309006a3',
            'http://schemas.microsoft.com/identity/claims/displayname' => 'Bob Moran',
            'http://schemas.xmlsoap.org/ws/2005/05/identity/claims/emailaddress' => 'bob@acme.fr',
            'http://schemas.xmlsoap.org/ws/2005/05/identity/claims/givenname' => 'Bob',
            'http://schemas.xmlsoap.org/ws/2005/05/identity/claims/surname' => 'Moran',
            'http://schemas.xmlsoap.org/ws/2005/05/identity/claims/name' => 'bob@acme.fr'
        )),
    ),
);
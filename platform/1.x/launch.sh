...
main() {
    ...
    pushd $WORKDIR > /dev/null
        ...
        curl -Lf https://raw.githubusercontent.com/gravitee-io/gravitee-docker/master/platform/1.x/docker-compose.yml -o "docker-compose.yml"
        cd mongo/docker-entrypoint-initdb.d && { curl -Lf https://raw.githubusercontent.com/gravitee-io/gravitee-docker/master/platform/1.x/mongo/docker-entrypoint-initdb.d/create-index.js -o "create-index.js" ; cd -; }
        cd traefik/certs && { curl -Lf https://raw.githubusercontent.com/gravitee-io/gravitee-docker/master/platform/1.x/traefik/certs/gio-selfsigned.crt -o "gio-selfsigned.crt" ; cd -; }
        cd traefik/certs && { curl -Lf https://raw.githubusercontent.com/gravitee-io/gravitee-docker/master/platform/1.x/traefik/certs/gio-selfsigned.key -o "gio-selfsigned.key" ; cd -; }
        cd traefik/config && { curl -Lf https://raw.githubusercontent.com/gravitee-io/gravitee-docker/master/platform/1.x/traefik/config/traefik.toml -o "traefik.toml" ; cd -; }
        cd gravitee && { curl -Lf https://raw.githubusercontent.com/gravitee-io/gravitee-docker/master/platform/1.x/gravitee/cacerts -o "cacerts" ; cd -; }
        echo
